  ...
  _createClass(MUIPlacesAutocomplete, null, [{
    ...
    value: function renderSuggestions(suggestions, _ref2) {
      ...
      return suggestions.map(function (suggestion, index) {
        return MUIPlacesAutocomplete.renderSuggestion(suggestion, {
    ...
    value: function renderAutocomplete(_ref4) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { tag: false },
          _react2.default.createElement(_TextField2.default, getInputProps(_extends({
          ...
          isOpen ? MUIPlacesAutocomplete.renderSuggestionsContainer(suggestions, {
            getItemProps: getItemProps,
            inputValue: inputValue,
